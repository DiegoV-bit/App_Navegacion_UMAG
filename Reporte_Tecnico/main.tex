...
\begin{itemize}
  ...
  \item Diseñar y modelar grafos de navegación para cada piso del edificio, incluyendo salas, pasillos, laboratorios y oficinas.
  \item Implementar el algoritmo A* para calcular rutas óptimas entre puntos de interés dentro del mismo piso.
  \item Integrar tecnologías de posicionamiento mediante códigos QR que permitan identificar la ubicación del usuario.
  \item Desarrollar una interfaz gráfica intuitiva con visualización de mapas SVG interactivos y control de zoom.
\end{itemize}
\newpage
...
\begin{enumerate}
  ...
  \item Implementación del algoritmo A* para cálculo de rutas.
  \item Creación y generación automatizada de códigos QR.
  \item Sistema de lectura e interpretación de códigos QR.
  \item Solución al problema de compatibilidad de formatos QR.
  \item Sistema de navegación y cálculo de rutas.
  \item Pantalla de selección de destino.
  \item Integración del escáner QR con la navegación.
\end{enumerate}
...
\begin{wrapfigure}{r}{0.35\textwidth}
  \vspace{-10pt}
  \centering
  \includegraphics[width=0.18\textwidth]{LibreCAD_logo.png}
  \vspace{5pt}
  
  \includegraphics[width=0.18\textwidth]{Inkscape_Logo.svg.png}
  \vspace{-10pt}
  \caption{Logos de LibreCAD (arriba) e Inkscape (abajo)}
\end{wrapfigure}
...
\begin{figure}[!htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Mapa_original.png}
    
    \textbf{Antes: Plano original}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{Mapa.jpg}
    
    \textbf{Después: Plano simplificado}
  \end{minipage}
  \caption{Comparación del proceso de digitalización: plano original con elementos decorativos (izq.) vs. plano simplificado para navegación (der.)}
  \label{fig:digitalizacion_comparacion}
\end{figure}
\newpage
...
\begin{wrapfigure}{r}{0.35\textwidth}
  \vspace{-10pt}
  \centering
  \includegraphics[width=0.18\textwidth]{Flutter.png}
  \vspace{5pt}
  
  \includegraphics[width=0.18\textwidth]{Dart.png}
  \vspace{-10pt}
  \caption{Logos de Flutter (arriba) y Dart (abajo)}
\end{wrapfigure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.6\textwidth]{Repo_github.png}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.3\textwidth]{Pantalla_inicio.png}
  \caption{Pantalla de inicio de la aplicación mostrando las cuatro opciones de pisos con iconos distintivos}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Primer piso: \texttt{Mapas/Primer piso fac\_ing simple.svg}
    \item Segundo piso: \texttt{Mapas/Segundo piso fac\_ing simple.svg}
  ...
  \begin{itemize}
    ...
    \item Centrar el mapa en el patio de ingeniería (nodo P1\_Patio\_de\_ingenieria con coordenadas 567, 478), representado con un ícono de brújula (Icons.explore) similar a Google Maps
  \end{itemize}
...
% ===========================================================================
% IMAGEN REQUERIDA: Vista del mapa SVG con controles de navegación
% ===========================================================================
% INSTRUCCIONES:
% 1. Abre la aplicación y selecciona cualquier piso (preferiblemente Piso 1)
% 2. Captura la pantalla del mapa mostrando:
%    - El mapa SVG completo del piso ocupando la mayor parte de la pantalla
%    - El header con el nombre del piso y botón de regreso
%    - La barra informativa azul claro debajo del header
%    - LOS 3 BOTONES FLOTANTES en la esquina inferior derecha:
%      * Botón de zoom in (+)
%      * Botón de zoom out (-)
%      * Botón de centrar (ícono de brújula/explore)
% 3. Asegúrate que el mapa se vea claramente con:
%    - Paredes y pasillos visibles
%    - Salas etiquetadas si es posible
%    - Nivel de zoom normal (no muy acercado ni muy alejado)
% 4. Los botones flotantes deben verse claramente
% 5. NO incluyas barra de estado del dispositivo
% 6. Guarda como: image/mapa_con_controles_navegacion.png
% 7. Resolución: Captura nativa del emulador, formato PNG
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{mapa_con_controles_navegacion.png}
  \caption{Vista del mapa SVG del primer piso con controles de zoom y centrado en la esquina inferior derecha}
  \label{fig:mapa_controles}
\end{figure}

% ===========================================================================
% IMAGEN REQUERIDA: Demostración de funcionalidad de zoom
% ===========================================================================
% INSTRUCCIONES:
% 1. Crea una imagen compuesta con DOS capturas lado a lado
% 2. CAPTURA IZQUIERDA - Zoom Out (vista general):
%    - Abre el mapa de un piso
%    - Usa el botón de zoom out (-) varias veces
%    - Captura mostrando el piso completo visible
%    - El mapa debe verse pequeño pero completo
% 3. CAPTURA DERECHA - Zoom In (vista detallada):
%    - En el mismo mapa, usa el botón de zoom in (+) varias veces
%    - Enfoca en una sección específica (sala, pasillo, etc.)
%    - Captura mostrando detalles ampliados (números de salas visibles)
% 4. Une ambas capturas en una sola imagen lado a lado
% 5. Opcionalmente agrega texto "Vista General" y "Vista Detallada"
% 6. Guarda como: image/demostracion_zoom_niveles.png
% 7. Cada captura 1080x1920, imagen final 2160x1920, formato PNG
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.9\textwidth]{demostracion_zoom_niveles.png}
  \caption{Comparación de niveles de zoom: vista general del piso completo (izq.) vs. vista detallada con zoom aplicado (der.)}
  \label{fig:zoom_demo}
\end{figure}
...
% ===========================================================================
% IMAGEN OPCIONAL: Estructura JSON del archivo de grafo
% ===========================================================================
% INSTRUCCIONES:
% 1. Abre el archivo lib/data/grafo_piso1.json en VS Code
% 2. Asegúrate que el formato JSON esté bien formateado (indentado)
% 3. Captura de pantalla mostrando:
%    - El editor de código (VS Code) con syntax highlighting
%    - La estructura JSON clara con:
%      * Array de "nodos" con al menos 3-4 nodos visibles
%      * Cada nodo mostrando: id, x, y
%      * Array de "conexiones" con al menos 2-3 conexiones visibles
%      * Cada conexión mostrando: origen, destino, distancia
% 4. Los colores del syntax highlighting deben estar activos
% 5. La fuente debe ser legible
% 6. NO captures todo el archivo (solo una porción representativa)
% 7. Guarda como: image/estructura_json_grafo.png
% 8. Formato PNG, resolución suficiente para leer el código
% 9. Esta imagen es OPCIONAL pero recomendada
% ===========================================================================
%\begin{figure}[!h]
%  \centering
%  \includegraphics[width=0.7\textwidth]{estructura_json_grafo.png}
%  \caption{Estructura JSON de un archivo de grafo mostrando nodos con coordenadas y conexiones con distancias}
%  \label{fig:json_grafo}
%\end{figure}
...
\textbf{Centrado en punto de referencia.} La aplicación implementa un sistema de centrado que enfoca el mapa en el patio de ingeniería al iniciar y al presionar el botón de brújula:

\begin{lstlisting}[language=Dart, caption={Centrado en el patio de ingeniería}]
void _centrarEnPatio() {
  // Coordenadas del patio de ingenieria en el piso 1
  ...
  // Crear matriz de transformacion con escala 1.0 y traduccion al patio
...
void _resetZoom() {
  // Centra la vista en el patio de ingenieria (coordenadas: 567, 478)
  _centrarEnPatio();
}
\end{lstlisting}

Esta funcionalidad se ejecuta automáticamente al abrir el mapa mediante \texttt{WidgetsBinding.instance.addPostFrameCallback()} en el método \texttt{initState()}, asegurando que el usuario siempre comience con el patio de ingeniería como punto de referencia central.
...
% ===========================================================================
% IMAGEN REQUERIDA: Ruta calculada con algoritmo A* visualizada en el mapa
% ===========================================================================
% INSTRUCCIONES:
% 1. Abre la aplicación en un piso (preferiblemente Piso 1)
% 2. Selecciona un NODO ORIGEN (debe aparecer marcador VERDE)
% 3. Selecciona un NODO DESTINO alejado del origen (marcador ROJO)
% 4. La aplicación debe calcular y mostrar la ruta con A*
% 5. Captura de pantalla mostrando:
%    - El mapa SVG de fondo claramente visible
%    - MARCADOR VERDE en el punto de origen
%    - MARCADOR ROJO en el punto de destino
%    - LÍNEAS AZULES conectando origen y destino a través de la ruta
%    - NODOS INTERMEDIOS marcados a lo largo de la ruta
%    - La ruta debe seguir pasillos y ser visualmente clara
% 6. Asegúrate que la ruta sea lo suficientemente larga para demostrar el algoritmo
%    (al menos 5-7 nodos intermedios)
% 7. Opcionalmente incluye el mensaje de distancia total si está visible
% 8. Guarda como: image/ruta_calculada_a_estrella.png
% 9. Formato PNG, captura nativa del emulador
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.65\textwidth]{ruta_calculada_a_estrella.png}
  \caption{Ruta óptima calculada con el algoritmo A* desde el origen (verde) hasta el destino (rojo), mostrando el camino con líneas azules y nodos intermedios}
  \label{fig:ruta_a_estrella}
\end{figure}

% ===========================================================================
% IMAGEN REQUERIDA: Mensaje de confirmación con distancia total
% ===========================================================================
% INSTRUCCIONES:
% 1. Después de calcular una ruta, debe aparecer un SNACKBAR o mensaje
% 2. Captura de pantalla mostrando:
%    - El mapa con la ruta calculada de fondo
%    - El MENSAJE/SNACKBAR en la parte inferior con texto como:
%      "Ruta calculada: 156 metros" o similar
%    - El ícono de confirmación (check, ruta, etc.)
% 3. Asegúrate que el mensaje sea claramente legible
% 4. El mensaje debe estar visible (no desvanecido)
% 5. La ruta en el mapa debe verse también
% 6. Guarda como: image/mensaje_distancia_ruta.png
% 7. Formato PNG, captura nativa del emulador
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{mensaje_distancia_ruta.png}
  \caption{Mensaje de confirmación mostrando la distancia total de la ruta calculada}
  \label{fig:mensaje_distancia}
\end{figure}
...
% ===========================================================================
% IMAGEN REQUERIDA: Collage de múltiples códigos QR generados
% ===========================================================================
% INSTRUCCIONES:
% 1. Navega a la carpeta qr_codes/ del proyecto
% 2. Selecciona 6 códigos QR diferentes de distintos pisos, por ejemplo:
%    - P1_Entrada_1.png
%    - P1_Lab_Tesla.png
%    - P2_Lab_comp_facultad_ciencias.png
%    - P2_Sala_23.png
%    - P3_Departamento_matematica_fisica.png
%    - P4_Sala_41.png
% 3. Usa una herramienta de edición (GIMP, Photoshop, etc.) para crear un collage
% 4. Organiza los 6 QR en una cuadrícula de 3x2 o 2x3
% 5. Debajo de cada QR agrega su ID en texto pequeño
% 6. Asegúrate que cada QR sea:
%    - Claramente escaneable (no muy pequeño)
%    - Con borde blanco alrededor
%    - Tamaño similar entre todos
% 7. Fondo blanco para el collage
% 8. Guarda como: image/collage_codigos_qr_generados.png
% 9. Resolución final: 1200x800 aproximadamente, formato PNG
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.75\textwidth]{collage_codigos_qr_generados.png}
  \caption{Ejemplos de códigos QR generados automáticamente para diferentes puntos de interés en los cuatro pisos}
  \label{fig:qr_collage}
\end{figure}
...
% ===========================================================================
% IMAGEN REQUERIDA: Pantalla del escáner QR activo
% ===========================================================================
% INSTRUCCIONES:
% 1. Abre la aplicación y accede al escáner de códigos QR
% 2. La cámara debe estar activa mostrando vista previa
% 3. Captura de pantalla mostrando:
%    - La VISTA PREVIA DE LA CÁMARA ocupando la mayoría de la pantalla
%    - Un CÓDIGO QR IMPRESO visible en el centro (puede estar en papel)
%    - El marco/recuadro de escaneo resaltado
%    - Instrucciones en pantalla como "Apunta al código QR"
%    - Botón para regresar o cerrar el escáner
% 4. El QR debe estar enfocado y parcialmente dentro del área de escaneo
% 5. NO captures después de escanear (debe ser durante el escaneo)
% 6. Asegúrate que se vea la interfaz del escáner claramente
% 7. Guarda como: image/pantalla_escaner_qr_activo.png
% 8. Formato PNG, captura nativa del emulador
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.45\textwidth]{pantalla_escaner_qr_activo.png}
  \caption{Pantalla de lectura de códigos QR con vista previa de cámara activa}
  \label{fig:escaner_qr}
\end{figure}

% ===========================================================================
% IMAGEN REQUERIDA: Mensaje de confirmación de QR válido
% ===========================================================================
% INSTRUCCIONES:
% 1. Escanea un código QR válido con la aplicación
% 2. Debe aparecer un MENSAJE de confirmación
% 3. Captura de pantalla mostrando:
%    - El mapa que se abrió después del escaneo
%    - SNACKBAR o DIÁLOGO de confirmación con texto como:
%      "QR válido: P1_Entrada_2" o
%      "Código escaneado correctamente: [ID del nodo]"
%    - Ícono de éxito (check verde, etc.)
% 4. El nodo correspondiente debe estar seleccionado/resaltado en el mapa
% 5. El mensaje debe ser claramente visible
% 6. Guarda como: image/confirmacion_qr_valido.png
% 7. Formato PNG, captura nativa del emulador
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{confirmacion_qr_valido.png}
  \caption{Mensaje de confirmación de lectura exitosa de código QR mostrando el ID del nodo identificado}
  \label{fig:qr_confirmacion}
\end{figure}
...
% ===========================================================================
% IMAGEN REQUERIDA: Código QR físico instalado o maqueta
% ===========================================================================
% INSTRUCCIONES:
% 1. OPCIÓN A (si tienes QR físico instalado):
%    - Toma una foto de un código QR impreso e instalado en la facultad
%    - Debe verse el código QR en su contexto (junto a puerta, en pared, etc.)
%    - El QR debe ser claramente visible y escaneable
%    - Incluye parte del entorno (marco de puerta, número de sala, etc.)
% 2. OPCIÓN B (si no tienes instalado, crea maqueta):
%    - Imprime un código QR en papel
%    - Pégalo temporalmente en una puerta o pared
%    - Agrega una etiqueta con el ID del nodo (ej: "Sala 23")
%    - Toma una foto mostrando cómo se vería instalado
% 3. La foto debe mostrar:
%    - El código QR claramente visible (tamano minimo 5x5 cm)
%    - Contexto de la ubicacion (puerta, pared, pasillo)
%    - Buena iluminacion para que el QR se vea nitido
% 4. Guarda como: image/qr_fisico_instalado.png o .jpg
% 5. Resolucion: 1920x1080 minimo
% 6. Formato: JPG para fotos reales, PNG para maquetas digitales
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.5\textwidth]{qr_fisico_instalado.png}
  \caption{Ejemplo de código QR instalado en punto estratégico para identificación de ubicación}
  \label{fig:qr_fisico}
\end{figure}
...
\subsubsection{Sistema de navegación y cálculo de rutas}
...
\paragraph{Restricción de navegación por piso}

El sistema actual está diseñado para navegar dentro de un mismo piso por simplicidad y eficiencia. Cuando el usuario intenta seleccionar un destino en un piso diferente al origen, la aplicación valida esta condición y muestra un mensaje de advertencia:

\begin{lstlisting}[language=Dart, caption={Validación de mismo piso}]
void _establecerDestino(String nodoId) async {
  // Verificar que origen y destino esten en el mismo piso
  ...
  // Continuar con calculo de ruta usando A*
  setState(() => _destinoSeleccionado = nodoId);
...
\begin{enumerate}
  ...
  \item Seleccionar el piso destino deseado
  \item Establecer un nuevo origen y destino dentro de ese piso
\end{enumerate}

% ===========================================================================
% IMAGEN REQUERIDA: Selección de origen y destino en el mapa
% ===========================================================================
% INSTRUCCIONES:
% 1. Abre la aplicación en un piso
% 2. Selecciona un nodo como ORIGEN (debe aparecer marcador VERDE)
% 3. Selecciona otro nodo como DESTINO (marcador ROJO)
% 4. NO calcules la ruta todavía (solo deben verse los dos nodos seleccionados)
% 5. Captura de pantalla mostrando:
%    - El mapa SVG claramente visible
%    - MARCADOR VERDE en el nodo de origen
%    - MARCADOR ROJO en el nodo de destino
%    - Los dos nodos deben estar separados (no muy cerca)
%    - NO debe haber línea de ruta todavía (solo los marcadores)
% 6. Asegúrate que ambos marcadores sean claramente visibles
% 7. Opcional: Incluye etiquetas o IDs de los nodos seleccionados
% 8. Guarda como: image/seleccion_origen_destino.png
% 9. Formato PNG, captura nativa del emulador
% ===========================================================================
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.6\textwidth]{seleccion_origen_destino.png}
  \caption{Selección de nodo origen (verde) y nodo destino (rojo) mediante interacción táctil en el mapa}
  \label{fig:seleccion_nodos}
\end{figure}

\paragraph{Cálculo de rutas con A*}

Una vez validado que origen y destino están en el mismo piso, el sistema procede a calcular la ruta óptima:

\begin{lstlisting}[language=Dart, caption={Cálculo de ruta en el mismo piso}]
Future<void> _calcularYMostrarRuta(String origen, String destino) async {
  try {
    final grafoJson = await rootBundle.loadString(rutaGrafoJson);
    final grafoData = json.decode(grafoJson);
    final grafo = Grafo.fromJson(grafoData);
    ...
    if (ruta.isEmpty) {
      _mostrarError('No se encontro una ruta entre los puntos');
      return;
    }
    
    // Actualizar estado con la ruta calculada
    setState(() {
      _rutaActiva.clear();
    ...
    _mostrarConfirmacion(
      'Ruta calculada: ${distancia.toStringAsFixed(1)} metros'
    );
  } catch (e) {
    _mostrarError('Error al calcular ruta: $e');
  }
}
\end{lstlisting}

\paragraph{Visualización de la ruta}

La ruta calculada se visualiza sobre el mapa mediante un sistema de líneas dibujadas con \texttt{CustomPainter}:

\begin{itemize}
  \item \textbf{Líneas de ruta}: Conectan secuencialmente los nodos del camino calculado
  \item \textbf{Marcadores especiales}: El origen se destaca en verde y el destino en rojo
  \item \textbf{Nodos intermedios}: Se marcan en azul a lo largo del recorrido
  \item \textbf{Información de distancia}: Se muestra la distancia total en la interfaz
\end{itemize}

\begin{lstlisting}[language=Dart, caption={Construcción de líneas de ruta}]
List<Widget> _buildLineasRuta() {
  ...
  for (int i = 0; i < _rutaActiva.length - 1; i++) {
    final nodoActual = _nodos.firstWhere(
      (n) => n['id'] == _rutaActiva[i]
    );
    final nodoSiguiente = _nodos.firstWhere(
      (n) => n['id'] == _rutaActiva[i + 1]
    );
    
    final inicio = _calcularPosicionEscalada(
      nodoActual['x'] as double,
      nodoActual['y'] as double,
    );
    final fin = _calcularPosicionEscalada(
      nodoSiguiente['x'] as double,
      nodoSiguiente['y'] as double,
    );
    
    lineas.add(
      CustomPaint(
        painter: RutaPainter(inicio: inicio, fin: fin),
      ),
    );
  }
...
\paragraph{Limpieza de selección}

El usuario puede limpiar la selección actual y comenzar una nueva navegación en cualquier momento:

\begin{lstlisting}[language=Dart, caption={Limpieza de ruta activa}]
void _limpiarSeleccion() {
  setState(() {
    ...
    // Limpiar conexiones debug si estan activas
    if (_modoDebugActivo) {
...
\paragraph{Ventajas del enfoque simplificado}

\begin{itemize}
  \item \textbf{Simplicidad}: La interfaz es más intuitiva al enfocarse en un piso a la vez
  \item \textbf{Rendimiento}: Reduce la carga computacional al trabajar con grafos individuales
  \item \textbf{Claridad visual}: El usuario siempre ve claramente el piso en el que está navegando
  \item \textbf{Mantenibilidad}: El código es más simple y fácil de mantener sin lógica multi-piso
  \item \textbf{Escalabilidad}: Permite agregar nuevos pisos sin complejidad adicional en el sistema de navegación
\end{itemize}
...
\textbf{Lista de nodos disponibles.} La pantalla muestra todos los nodos del piso actual con las siguientes capacidades:
\begin{itemize}
  \item Visualización de todos los destinos posibles dentro del mismo piso
...
\textbf{Selección directa.} El usuario puede:
\begin{itemize}
  \item Tocar cualquier nodo en el mapa para establecerlo como origen o destino
  \item Ver información detallada de cada nodo al seleccionarlo
  \item Confirmar la selección mediante diálogos intuitivos
  \item Visualizar la ruta calculada inmediatamente después de seleccionar ambos puntos
\end{itemize}

\paragraph{Flujo de uso}

\begin{enumerate}
  \item El usuario escanea un código QR o toca un nodo en el mapa para establecer el origen
  \item Selecciona un segundo nodo en el mismo piso como destino
  \item La aplicación valida que ambos nodos estén en el mismo piso
  \item Si la validación es exitosa, se calcula automáticamente la ruta con A*
  \item La ruta se visualiza sobre el mapa con líneas y marcadores
  \item El usuario puede limpiar la selección y comenzar una nueva ruta en cualquier momento
\end{enumerate}

\paragraph{Limitación actual}

Actualmente, la aplicación solo permite navegar dentro del mismo piso. Si el usuario intenta seleccionar un destino en un piso diferente, se muestra un mensaje indicando que debe navegar manualmente al piso destino:

\begin{quote}
\textit{``El origen y destino deben estar en el mismo piso. Por favor, selecciona el piso destino desde el menú principal.''}
\end{quote}
...
\subsubsection{Integración del escáner QR con la navegación}
...
\begin{enumerate}
  \item El usuario escanea un código QR físico ubicado en un punto de la facultad
  \item El sistema identifica el nodo correspondiente en el grafo del piso actual
  \item Se establece automáticamente como punto de origen para la navegación
  \item El usuario puede seleccionar un destino tocando otro nodo en el mapa
  \item La aplicación calcula y muestra la ruta óptima usando A*
\end{enumerate}
...
\begin{itemize}
  \item Se digitalizaron y optimizaron los planos arquitectónicos de los 4 pisos del edificio, convirtiéndolos a formato SVG para su visualización interactiva.
  
  \item Se implementó el algoritmo A* para el cálculo de rutas óptimas, demostrando ser eficiente y preciso para la navegación en espacios interiores.
  
  \item Se desarrolló un sistema de modelado mediante grafos que representa fielmente la topología de cada piso, incluyendo más de 100 nodos distribuidos entre salas, laboratorios, oficinas y pasillos.
  
  \item Se integró exitosamente un sistema de códigos QR que permite a los usuarios identificar rápidamente su ubicación actual, generando automáticamente 108 códigos QR para todos los puntos de interés.
  
  \item Se creó una interfaz gráfica intuitiva utilizando Flutter, con soporte para zoom, desplazamiento y visualización clara de rutas sobre mapas vectoriales.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Claridad visual}: El usuario siempre tiene claro en qué piso se encuentra y hacia dónde se dirige.
  
  \item \textbf{Simplicidad de uso}: La interfaz es más intuitiva al no requerir gestión compleja de cambios de piso durante la navegación.
  
  \item \textbf{Mantenibilidad del código}: El código resultante es más simple y fácil de mantener, reduciendo la probabilidad de errores.
  
  \item \textbf{Rendimiento}: Al trabajar con grafos individuales por piso, la aplicación consume menos recursos computacionales.
\end{itemize}
...
\begin{itemize}
  \item \textbf{Implementar navegación multi-piso}: Desarrollar un gestor que calcule rutas completas atravesando múltiples pisos mediante escaleras y ascensores, proporcionando opciones alternativas cuando existan múltiples caminos.
  
  \item \textbf{Agregar navegación en tiempo real}: Integrar seguimiento continuo de la posición del usuario mediante Bluetooth beacons o Wi-Fi positioning para actualizar la ruta dinámicamente.
  
  \item \textbf{Incluir características de accesibilidad}: Identificar rutas accesibles para personas con movilidad reducida, priorizando ascensores sobre escaleras y evitando obstáculos.
  
  \item \textbf{Expandir la cobertura}: Extender el sistema a otros edificios del campus universitario, creando una red de navegación completa.
  
  \item \textbf{Añadir información contextual}: Incluir horarios de clases, disponibilidad de salas, y puntos de interés como cafeterías, baños y servicios estudiantiles.
  
  \item \textbf{Implementar modo offline}: Permitir el uso de la aplicación sin conexión a internet, descargando todos los mapas y datos necesarios de forma anticipada.
  
  \item \textbf{Desarrollar sistema de retroalimentación}: Permitir a los usuarios reportar problemas, sugerir mejoras o actualizar información sobre nodos y conexiones.
\end{itemize}
