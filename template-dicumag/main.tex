...
\section{Metodología}
Describa los pasos principales realizados durante la práctica. Puede apoyarse en subsecciones:
\begin{enumerate}
  \item Placeholder para primera etapa del trabajo.
  \item Placeholder para segunda etapa del trabajo.
  \item Placeholder para validación y resultados.
\end{enumerate}
