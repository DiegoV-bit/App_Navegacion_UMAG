# App_Navegacion_UMAG
Repositorio en donde se trabajara en una aplicación de navegación interna para la facultad de Ingeniería de la Universidad de Magallanes.
...
gantt
    ...
    Visualización de las rutas (Diego)           :active, dev20, 2025-12-4, 2025-12-10
    Funcionalidades (QR busqueda selector de piso) (Diego) :active, dev21, 2025-10-27, 2025-11-09
